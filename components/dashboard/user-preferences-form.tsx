...
// Define the platform keys explicitly if not already defined in UpdatePreferencesData
type PlatformKey =
  | "instagram"
  | "facebook"
  | "tiktok"
...
type UserPreferencesProps = {
  ...
  onUpdate: (prev: number) => number;
};

export function UserPreferencesForm({ data, onUpdate }: UserPreferencesProps) {
  ...
  const form = useForm<UpdatePreferencesData>({
    ...
    defaultValues: {
      ...
      contentFormality: data.contentFormality,
      contentLength: data.contentLength,
      contentFrequency: data.contentFrequency,
      contentEmojis: data.contentEmojis,
      contentHashtags: data.contentHashtags,
      contentCallToAction: data.contentCallToAction,
      ...
      contentToAvoid: data.contentToAvoid,
    },
  });
  ...
  useEffect(() => {
    const totalFields =
      ...
      Object.keys(preferences.platforms ?? {}).length;
  ...
  const handleReset = useCallback(() => {
    ...
    toast({
      ...
      description:
        "Your content preferences have been reset to default values.",
    });
  }, []);
  ...
  const updatePreference = useCallback(
    (key: keyof UpdatePreferencesData, value: any) => {
      setPreferences((prev) => ({
        ...prev,
        [key]: value,
      }));
  ...
  const updatePlatform = useCallback(
    (platform: PlatformKey, enabled: boolean) => {
      setPreferences((prev) => ({
        ...prev,
        platforms: {
          instagram: prev.platforms?.instagram!,
          facebook: prev.platforms?.facebook!,
          tiktok: prev.platforms?.tiktok!,
          twitter: prev.platforms?.twitter!,
          linkedin: prev.platforms?.linkedin!,
          youtube: prev.platforms?.youtube!,
          [platform]: enabled,
        },
      }));
    },
  ...
  const updateArrayPreference = useCallback(
    (key: keyof UpdatePreferencesData, value: string, add: boolean) => {
      setPreferences((prev) => {
      ...
      <CardContent>
          ...
          <TabsContent value="business" className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updatePreference("businessName", e.target.value)
                  }
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updatePreference("businessType", value)
                  }
                >
                  <SelectTrigger
                    id="business-type"
              ...
              >
                ...
                <Select
                  ...
                  onValueChange={(value) => updatePreference("industry", value)}
                >
                  <SelectTrigger
                    id="industry"
                    className="rounded-lg border-2 border-primary/20 focus-visible:ring-primary"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updatePreference("businessSize", value)
                  }
                >
                  <SelectTrigger
                    id="business-size"
            ...
            >
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updatePreference("yearsInBusiness", value)
                }
              >
                <SelectTrigger
          ...
          <TabsContent value="audience" className="space-y-6">
                ...
                {["18-24", "25-34", "35-44", "45-54", "55-64", "65+"].map(
                  (age) => (
                    <Badge
                      key={age}
                      variant={
                        preferences.targetAge?.includes(age as TargetAge)
                          ? "default"
                          : "outline"
                      }
                      ...
                      onClick={() => {
                        if (preferences.targetAge?.includes(age as TargetAge)) {
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {["male", "female", "all"].map((gender) => (
                  <Badge
                    key={gender}
                    variant={
                      preferences.targetGender?.includes(gender as TargetGender)
                        ? "default"
                        : "outline"
                    }
                    className={`cursor-pointer ${
                    ...
                    onClick={() => {
                      ...
                      if (gender === "all") {
                        ...
                        let newGenders = [
                          ...(preferences.targetGender as TargetGender[]),
                        ];
                        ...
                        if (newGenders.includes(gender as TargetGender)) {
                          ...
                          newGenders.push(gender as TargetGender);
                        }
            ...
            >
              ...
              <Input
                ...
                onChange={(e) =>
                  updatePreference("targetLocation", e.target.value)
                }
                className="rounded-lg border-2 border-primary/20 focus-visible:ring-primary"
              />
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updatePreference("contentTone", value)
                  }
                >
                  <SelectTrigger
                    id="content-tone"
              ...
              >
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updatePreference("contentFormality", value)
                  }
                >
                  <SelectTrigger
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updatePreference("contentLength", value)
                  }
                >
                  <SelectTrigger
                    id="content-length"
              ...
              >
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    updatePreference("contentFrequency", value)
                  }
                >
                  <SelectTrigger
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updatePreference("contentEmojis", checked)
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updatePreference("contentHashtags", checked)
                  }
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Add clear CTAs to engage your audience
                  </p>
                </div>
                <Switch
                  id="content-cta"
                  ...
                  onCheckedChange={(checked) =>
                    updatePreference("contentCallToAction", checked)
                  }
                />
              </div>
            </motion.div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div className="flex items-center space-x-4 p-4 rounded-lg border-2 border-primary/10 bg-card">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updatePlatform("instagram", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 rounded-lg border-2 border-primary/10 bg-card">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updatePlatform("facebook", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 rounded-lg border-2 border-primary/10 bg-card">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updatePlatform("twitter", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 rounded-lg border-2 border-primary/10 bg-card">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updatePlatform("linkedin", checked)
                    }
                  />
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 rounded-lg border-2 border-primary/10 bg-card">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      updatePlatform("youtube", checked)
                    }
                  />
                </div>
              </div>
          ...
          <TabsContent value="brand" className="space-y-6">
            ...
            >
              ...
              <Select
                ...
                onValueChange={(value) =>
                  updatePreference("brandPersonality", value)
                }
              >
                <SelectTrigger
            ...
            >
              ...
              <Textarea
                ...
                onChange={(e) =>
                  updatePreference("brandDescription", e.target.value)
                }
              />
              <p className="text-xs text-muted-foreground">
          ...
          <TabsContent value="examples" className="space-y-6">
                ...
                {preferences.competitorUrls?.map((url) => (
                  ...
                  >
                    ...
                    <Button
                      ...
                      className="h-4 w-4 rounded-full p-0 text-secondary"
                      onClick={() =>
                        updateArrayPreference("competitorUrls", url, false)
                      }
                    >
                      <X className="h-3 w-3" />
                      <span className="sr-only">Remove</span>
            ...
            >
              ...
              <Textarea
                ...
                onChange={(e) =>
                  updatePreference("favoriteContent", e.target.value)
                }
              />
              <p className="text-xs text-muted-foreground">
            ...
            >
              ...
              <Textarea
                ...
                onChange={(e) =>
                  updatePreference("contentToAvoid", e.target.value)
                }
              />
              <p className="text-xs text-muted-foreground">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mt-8 gap-4">
          <div className="relative order-2 sm:order-1">
            <Mascot
              emotion="thinking"
              message="These details help me create better content ideas for you!"
              size="md"
            />
          </div>
          <Button
